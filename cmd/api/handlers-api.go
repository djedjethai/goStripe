...
func (app *application) CreateCustomerAndSubscribeToPlan(w http.ResponseWriter, r *http.Request) {
	...
	if okay {
		// create transaction, customer localy, order, and save all this infos
		productID, err := strconv.Atoi(data.ProductID)
		if err != nil {
			app.errorLog.Println(err)
			return
		}
		// here we assume that any transaction is a new customer
...
// Save customer and return the Id
...
// client lost password, request a new one passing his email in the form
...
func (app *application) RefundCharge(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		app.badRequest(w, r, errors.New("The charge has been refund, but the database could not be updated"))
		return
	}
...
func (app *application) CancelSubscription(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		app.badRequest(w, r, errors.New("The subscription has been canceled, but the database could not be updated"))
		return
	}
	...
	resp.Error = false
	resp.Message = "Subscription deleted"
