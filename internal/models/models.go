...
func (m *DBModel) GetWidget(id int) (Widget, error) {
	...
	// coalesce will set an empty value if image is null
...
// InsertModel insert an order and return its id
...
// InsertModel insert a customer and return its id
...
// GetUserByEmail return a user matchint the email input
func (m *DBModel) GetUserByEmail(email string) (User, error) {
	ctx, cancel := context.WithTimeout(context.Background(), 3*time.Second)
	defer cancel()

	// store email as minuscule
